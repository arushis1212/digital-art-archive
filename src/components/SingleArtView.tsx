                ...
                <section className="bg-secondary/30 border-t border-border py-24">
                    <div className="container mx-auto max-w-6xl px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {/* Form */}
                            <section className="relative p-8 border border-border bg-white rounded-sm shadow-sm">
                                <h2 className="sticky top-0 text-xs font-bold text-accent uppercase tracking-widest mb-4 bg-white inline-block px-2 py-1 rounded">
                                    Form
                                </h2>
